...
function buatindex() {
		...
		print("<p align=center>Mengindeks sebanyak " . $num_rows . " berita. </p>");
...
function hitungbobot() {	
	...
	print("<p align=center>Terdapat " . $num_rows . " Term yang diberikan bobot. </p>");
...
function panjangvektor() {	
	...
	print("<p align=center>Terdapat " . $num_rows . " dokumen yang dihitung panjang vektornya. </p>");
